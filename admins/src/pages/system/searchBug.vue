<template>
  <div>
    <Row style="border-bottom:2px solid #EEE; padding-bottom: 10px;">
      <Col span="18">
      <div class="cpageTitle"><Icon size="20" type="ios-bug" /><span>故障排查</span></div>
   ...
   <br>
       ...
       <!--</Input><Button type="primary" @click="search()" >搜索</Button></div>-->
      <Input style="width:300px;" @on-search="gosearch" v-model="keyword" search enter-button="搜索" placeholder="请输入会议编号..." />
    <br>
    ...
    <Row>
      ...
      <div class="iv_items">
          ...
          <Col span="2">保证金</Col>
          <Col span="2">参会人数</Col>
          <Col span="4"><Button @click="viewmeeting" size="small">查看</Button></Col>
          </Row>
      </div>
